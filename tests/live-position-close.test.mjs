...
test("网关超时后先按 clientOrderId 查询，找到已下单结果时不重复提交", async () => {
  ...
  const response = await POST(closeRequest({ symbol: "BTCUSDT", percent: 25, liveSwitchOn: true, confirmation: "CLOSE_MARKET", clientOrderId: "alexMC1234567890123456789012345678" }));
