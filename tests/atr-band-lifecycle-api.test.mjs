...
test("ATR lifecycle route exposes persisted lifecycle groups and hourly scheduling", async () => {
  ...
  assert.match(maintenance, /hasAtrLifecycleScanBucket\(db, atrBandBucket\)/);
