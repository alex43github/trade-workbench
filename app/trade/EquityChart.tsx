...
export default function EquityChart({ exchange, points, theme }: { exchange: "BINANCE" | "BYBIT"; points: EquityPoint[]; theme: "dark" | "light" }) {
  ...
  return <div className="equity-chart-canvas" ref={containerRef} aria-label={`${exchange}账户资金曲线`} />;
}
