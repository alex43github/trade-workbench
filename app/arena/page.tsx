...
export default async function ArenaPage() {
  const data = await getArenaSnapshot();
  return <AdvisoryShell active="/arena" title="模拟竞赛" eyebrow="FOUR ISOLATED ACCOUNTS / SEASON 01">
    <section className={styles.notice}><b>{data.mode === "demo" ? "DEMO" : "FORMAL"}</b><p>四个账户相互隔离。正式盘初始500 USDT、最高10倍、逐仓、不自动续资；演示成绩不进入正式排行榜。</p></section>
