...
- [x] **Step 3: Implement exact domain types and pure rules**
...
- [x] **Step 3: Add additive D1 schema and initial expert rows**
...
- [x] **Step 4: Implement deterministic demo repository and read APIs**
...
- [x] **Step 1: Extend rendered-page tests and verify failure**
...
- [x] **Step 2: Preserve the old radar at `/radar` and replace `/` with the dashboard**
...
- [x] **Step 3: Implement consultation, arena, reviews, and replay pages**
...
- [x] **Step 4: Run page tests and lint**
...
- [x] **Step 1: Write failing snapshot/orchestrator tests**
...
- [x] **Step 3: Implement closed-candle gateway and hash**
...
- [x] **Step 4: Implement strict OpenAI runner and orchestration**
...
- [x] **Step 5: Add protected run endpoint and environment documentation**
...
- [x] **Step 3: Implement notification and account validation**
...
- [x] **Step 4: Integrate safe post-consensus actions**
...
- [x] **Step 1: Document local use and explicit limitations**
...
- [x] **Step 3: Start the site and inspect desktop/mobile pages**
