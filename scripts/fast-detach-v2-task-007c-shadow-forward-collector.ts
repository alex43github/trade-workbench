...
type ResearchTrackedSignal = TrackedSignal & { score?: number };
type FeedOptions = {
...
export async function runTask007CShadowCollector(
  ...
  async function causalForSignal(signal: ResearchTrackedSignal, decisionMs: number) {
  ...
  async function persistSignal(signal: ResearchTrackedSignal) {
    return queue(async () => {
